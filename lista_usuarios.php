                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            ?>
                      <tr>
                        <td class="table-primary"><?php  echo $lista[$x]['id_user'] ?></td>
                        ...
                        <td>
                            ...
                            <a href="edit_user.php?idUser=<?php echo $lista[$x]['id_user'] ?>">
                            ...
                            <a href="delete_user.php?idUser=<?php echo $lista[$x]['id_user'] ?>">
                                <button onclick="confirmar_eliminar_usuario(<?php echo $lista[$x]['id_user']?> )" class="btn btn-danger">Eliminar</button>
                            </a>
                        </td>
                      </tr>
